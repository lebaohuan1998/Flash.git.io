					...
					<div class="form-block mx-auto">
						...
						<form id="register-form" class="form"
							...
							<div class="form-group">
								<label class="email">Email(*)</label> <input type="email"
									id="email" name="email" class="form-control col"
							...
							<div class="form-group">
								<button type="submit" class="btn btn-info btn-block my-3">Tạo
									tài khoản</button>
							</div>
						...
						<div class="form-group mb-0">
							<span class="my-3 d-block">Nếu bạn muốn đăng ký là người
								chụp ảnh hay người mẫu <a
								href="${pageContext.request.contextPath}/RegisterPhotographerOrModel">tại
									đây</a>
							</span>
						</div>
					</div>
