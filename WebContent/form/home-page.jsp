          ...
          <li class="nav-item  mr-4">
            <div class="dropdown show">
              ...
              <div class="dropdown-menu bg-dark" aria-labelledby="dropdownMenuLink">
                <a class="dropdown-item btn" href="log-in.jsp"><i class="fa fa-sign-in-alt mr-1"></i>Đăng nhập</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide rounded" data-ride="carousel">
        ...
        <div class="carousel-inner bg-dark">
          <div class="carousel-item ">
            <img class="d-block w-100 slider-home" src="pic/9.jpg" alt="First slide">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100 slider-home" src="pic/10.jpg" alt="Second slide">
          </div>
          <div class="carousel-item active ">
            <img class="d-block w-100 slider-home" src="pic/12.png" alt="Third slide">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100 slider-home" src="pic/8.jpg" alt="four slide">
          </div>
        </div>
        ...
        <div class="bgphotographer container-fluid container ">
          ...
          <div class="input-group  ">
            ...
            <div class=" bgimg col-3 bg-dark canle ">
              <div class="hover hover-1 bgimg1  "><img class="" src="pic/theloai/chandung1.jpg" alt="">
              ...
              <a class="" href="#">
                <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item ">
                      <img class="trongoc " src="pic/theloai/chandung1.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                      <img class="trongoc " src="pic/theloai/chandung2.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item active">
                      <img class="trongoc " src="pic/theloai/chandung3.jpg" alt="Third slide">
                    </div>
                  </div>
                </div>
              </a>
            ...
            <div class=" canle ">
              ...
              <a class="" href="#">
                <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item ">
                      <img class="trongoc " src="pic/theloai/cuoi1.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                      <img class="trongoc " src="pic/theloai/cuoi2.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item active">
                      <img class="trongoc " src="pic/theloai/cuoi3.jpg" alt="Third slide">
                    </div>
                  </div>
                </div>
              </a>
            ...
            <div class=" canle ">
              ...
              <a class="" href="#">
                <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item ">
                      <img class="trongoc " src="pic/theloai/kyyeu1.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                      <img class="trongoc " src="pic/theloai/kyyeu2.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item active">
                      <img class="trongoc " src="pic/theloai/kyyeu3.jpg" alt="Third slide">
                    </div>
                  </div>
                </div>
              </a>
            ...
            <div class=" canle ">
              ...
              <a class="" href="#">
                <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item ">
                      <img class="trongoc " src="pic/theloai/giadinh1.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                      <img class="trongoc " src="pic/theloai/giadinh2.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item active">
                      <img class="trongoc " src="pic/theloai/giadinh3.jpg" alt="Third slide">
                    </div>
                  </div>
                </div>
              </a>
            ...
            <div class=" canle ">
              ...
              <a class="" href="#">
                <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item ">
                      <img class="trongoc " src="pic/theloai/sanpham1.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                      <img class="trongoc " src="pic/theloai/diaoc2.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item active">
                      <img class="trongoc " src="pic/theloai/sanpham3.jpg" alt="Third slide">
                    </div>
                  </div>
                </div>
              </a>
            ...
            <div class=" canle ">
              ...
              <a class="" href="#">
                <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item ">
                      <img class="trongoc " src="pic/theloai/sukien3.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                      <img class="trongoc " src="pic/theloai/sukien2.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item active">
                      <img class="trongoc " src="pic/theloai/sukien1.jpg" alt="Third slide">
                    </div>
                  </div>
                </div>
              </a>
      ...
      <div class=" text-center">
        ...
        <div class="bgphotographer container-fluid container ">
          ...
          <div class="input-group  ">
            ...
            <div class="  col-5  ">
              <div class="  "><img class=" img-fluid" src="pic/ungtuyen.jpg" alt="">
              </div>
            </div>
      ...
      <div class=" text-center">
        ...
        <div class="bgphotographer container-fluid container ">
          ...
          <div class="input-group  ">
            ...
            <div class=" bgimg col-3 bg-dark canle ">
              <div class="hover hover-1 bgimg1  "><img class="" src="pic/3.jpg" alt="">
                <div class="hover-overlay"></div>
              </div>
            </div>
