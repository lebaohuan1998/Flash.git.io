...
<body onload="loadPage()">
	...
	<div class=""
		style="background: #fff; height: 700px; max-width: 100%;">
		<div
			...
			<div class="form-inline" style="border-bottom: 1px solid rgba(0,0,0,0.15);padding-bottom: 2x;">
				...
				<div style="width:640px; margin-left: 30px;margin-top:-60px;">
					...
					<nav aria-label="Page navigation example">
						<ul class="pagination">
							...
							<c:if test="${param.page ==null&&list==1}">text-white bg-dark</c:if>"
									href="${pageContext.request.contextPath}/ManageNotificationPhotographer?flag=7&page=${list}">${list}</a></li>
							</c:forEach>
...
<script type="text/javascript">
    function deletex($val) {
        ...
        $.ajax({
            url:  'ManageNotificationPhotographer?command=DELETE',
            type: "GET",  
            data : {
    			notificationId : $val,
